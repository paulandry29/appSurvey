...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2022 at 02:15 PM
...
(6, 'Survey dosen pengajar FTI 666', 3),
(7, 'SURVEY KEPUASAN PELANGGAN PADA PELAYANAN  PT. ANGKASA PURA I di BANDARA ADI SUCIPTO - YOGYAKARTA', 3),
(9, 'Analisa kebutuhan penyediaan hand sanitizer di lingkungan kampus', 3);
...
(12, 'Manfaat penggunaan lapangan uksw Salatiga', 3);
...
(1, '672018178', 'Paulus Andry Leksono', '672018178@student.uksw.edu', '$2y$10$9NqgxJz6buWnSSv1QrLNg.qQdoXv/hkNRJh1aOhXTSutIBikQXED6', 67, 4, 'cae45bc2ed28b22e4e44bea126b1b01a297', '2022-12-15 13:03:10'),
...
(13, '682018175', 'Karlos Saha', '682018175@student.uksw.edu', '$2y$10$Q5OAPDBK4qjN65rNO4iwm.yahUnUPNKP/O0/pus9oNRnaGfPL2DBq', 68, 4, '', ''),
...
--
ALTER TABLE `jawaban`
  MODIFY `id_jawaban` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `respon`
  MODIFY `id_respon` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `survey`
--
ALTER TABLE `survey`
  MODIFY `id_survey` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `temp_pertanyaan`
--
ALTER TABLE `temp_pertanyaan`
  MODIFY `id_pertanyaan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `temp_survey`
--
ALTER TABLE `temp_survey`
  MODIFY `id_survey` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
